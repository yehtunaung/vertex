...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.room.update',$room->id) }}"  id="myForm" enctype="multipart/form-data">
                @method("PUT")
                @csrf
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select {{ $errors->has('room_category_id') ? 'is-invalid' : '' }}" aria-label="Default select example" name="room_category_id">
                                ...
                                @foreach ($room_categories as $room_category)
                                    <option value="{{ $room_category->id }}" {{ $room->roomCategory->id === $room_category->id ? "selected" : "" }}>
